...
namespace OCPP201 {
    ...
    public:
        ...
        [[nodiscard]] std::optional<double> getMeasuredL1() const { return measured_L1; }
        [[nodiscard]] std::optional<double> getMeasuredL2() const { return measured_L2; }
        [[nodiscard]] std::optional<double> getMeasuredL3() const { return measured_L3; }
        [[nodiscard]] std::optional<double> getMeasuredN() const { return measured_N; }
        [[nodiscard]] std::optional<double> getMeasuredL1N() const { return measured_L1_N; }
        [[nodiscard]] std::optional<double> getMeasuredL2N() const { return measured_L2_N; }
        [[nodiscard]] std::optional<double> getMeasuredL3N() const { return measured_L3_N; }
        [[nodiscard]] std::optional<double> getMeasuredL1L2() const { return measured_L1_L2; }
        [[nodiscard]] std::optional<double> getMeasuredL2L3() const { return measured_L2_L3; }
        [[nodiscard]] std::optional<double> getMeasuredL3L1() const { return measured_L3_L1; }
